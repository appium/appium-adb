 ...
 * @param {boolean} waitForLaunch - Optional parameter of waitForLaunch caps to add wait in adb command
 */
apkUtilsMethods.startUri = async function startUri (uri, pkg, opts = { waitForLaunch: true }) {
  if (!uri || !pkg) {
