 ...
 *
 * @return {object} The mapping, where property names are 'appPackage' and 'appActivity'.
 *                  _null_ is assigned as properties value if no activity/package is currently focused.
 */
 ...
 *
 * @param {string} pkg - The name of the package to wait to.
 ...
 * @param {number} waitMs - Number of milliseconds to wait before timeout occurs.
 ...
 * @param {object} opts - Additional exec options. See https://github.com/appium/node-teen_process
 ...
 * @param {boolean} repalce - Whether to replace the package if it
 *                            already insatlled. True by default.
 * @param {number} timeout - The number of milliseconds to wait until
 ...
 * @return {object} A mapping object, where proprties are: 'apkStrings', containing
 *                  parsed resource file represented as JSON object, and 'localPath',
 *                  containing the path to the extracted file on the local filesystem.
 */
...
/**
 * Get the contry name of the device under test.
 *
 * @return {string} The name of device contry.
 */
 ...
 *                           filesystem.
 * @return {object} The mapping where properties are 'name', 'versionCode' and 'versionName'.
 *                  An empty object will be returned if they cannot be parsed.
 */
