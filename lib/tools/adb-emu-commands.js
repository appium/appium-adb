...
/**
 * Change the display orientatioo on the connected emulator.
...
/**
 * Emulate power capacility change on the connected emulator.
 *
 * @param {string|number} percent - Percentage value in range [0, 100].
 */
 ...
 *
 * @param {string|number} strength - A number in range [0, 4];
 ...
 *
 * @param {string} speed - One of possible NETWORK_SPEED values.
