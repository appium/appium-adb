 ...
 * @typedef {import('type-fest').ValueOf<typeof emuMethods.GSM_SIGNAL_STRENGTHS>} GsmSignalStrengths
 ...
 *
 * @this {import('../adb.js').ADB}
 * @param {'gsm'|'scsd'|'gprs'|'edge'|'umts'|'hspda'|'lte'|'evdo'|'full'} [speed='full']
