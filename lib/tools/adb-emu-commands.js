...
export const POWER_AC_STATES = Object.freeze({
  POWER_AC_ON: 'on',
  POWER_AC_OFF: 'off'
});
export const GSM_CALL_ACTIONS = Object.freeze({
  GSM_CALL: 'call',
  GSM_ACCEPT: 'accept',
  GSM_CANCEL: 'cancel',
  GSM_HOLD: 'hold'
});
export const GSM_VOICE_STATES = Object.freeze({
...
export const GSM_SIGNAL_STRENGTHS = Object.freeze([0, 1, 2, 3, 4]);

export const NETWORK_SPEED = Object.freeze({
...
/**
 * @typedef {import('type-fest').ValueOf<typeof SENSORS>} Sensors
 * @typedef {import('type-fest').ValueOf<typeof NETWORK_SPEED>} NetworkSpeed
 * @typedef {import('type-fest').ValueOf<typeof GSM_VOICE_STATES>} GsmVoiceStates
 * @typedef {import('type-fest').ValueOf<typeof GSM_CALL_ACTIONS>} GsmCallActions
 * @typedef {import('type-fest').ValueOf<typeof POWER_AC_STATES>} PowerAcStates
 *
 */
...
export async function gsmSignal (strength = 4) {
  ...
  if (!this.GSM_SIGNAL_STRENGTHS.includes(strengthInt)) {
    throw new TypeError(
