 ...
 * @param {string} srcApk - Full path to the existing application package, where
 *                          this manifest has to be insetred to. this package
 *                          will not be modified.
 * @param {string} dstApk - Full path to the resulting package, containing
 *                          the manifest. The file will be overriden if it already
 *                          exists.
 */
