...
/** @type {Record<string, ExecOutputFormat>} */
...
/**
 * @typedef {{outputFormat: 'full'}} TFullOutputOptions
 */
 ...
 * @return {Promise<TExecOpts extends TFullOutputOptions ? import('teen_process').TeenProcessExecResult : string>}
 ...
 * @return {Promise<TShellExecOpts extends TFullOutputOptions ? import('teen_process').TeenProcessExecResult : string>}
 * Command's stdout.
 * @throws {Error} If the command returned non-zero exit code.
 */
