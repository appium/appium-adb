 ...
 *
 * @param {string} pkg - The package name to be processed.
 * @param {string} cmdOutput - Optional parameter containing command output of
 ...
 *
 * @return {array} The list of IME names or an empty list.
 */
 ...
 *
 * @return {array} The list of enabled IME names or an empty list.
 */
 ...
 *                            _longitude_ and _latitude_. These should be valid
