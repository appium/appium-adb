 ...
 * to this.executable.path and this.executable.path properties.
 *
...
/**
 * Veirfy whether a device is connected.
 *
 ...
 * @return {object} The result of Regexp.exec operation (an array of
 * Match objects) or _null_ if no matches are found.
 */
 ...
 * that support components-based permssionss setting.
 *
 ...
 *
 * @param {string} pkg - The package name to be processed.
 * @param {string} cmdOutput - Op[tional parameter containing command output of
 *                             _pm dump_ command. It speeds this mathod up
 *                             if present.
 ...
 *
 * @return {array} The list of available location providers or an empty list.
 */
 ...
 *
 * @return {array} The list of IMEs names or an empty list.
 */
 ...
 *
 * @return {array} The list of enabled IMEs names or an empty list.
 */
 ...
 *
 * @param {number} length - The maximum length of the text in the field to be cleared.
 */
...
/**
 * Rertieve current screen orientation of the device under test.
 *
...
/**
 * Rertieve the screen lock state of the device under test.
 *
...
/**
 * Rertieve the state of the software keyboard on the device under test.
 *
 ...
 *
 * @return {promise} If resolved then contains the actual output of the given command.
 */
 ...
 * @param {boolean} isEmulator - Set it to true if the device under
 ...
 *
 * @param {object} location - Location object, which should contain two properties:
 *                            _longtitude_ and _latitude_. These should be valid
 *                            float numbers (strings).
 * @param {boolean} isEmulator - Set it to true if the device under
 *                               is an emulator rather than a real device.
 */
...
/**
 * Remove a path recursively on the device under test.
 *
 ...
 * @param {string} localPath - The destination path to the file on the local filesystem.
 */
...
/**
 * Remove TCP port forwarding with adb on the device under test. The fowarding
 ...
 * @return {array} The list of matched process IDs or an empty list.
 */
 ...
 *
 * @param {string} proxyHost - The hostname of the proxy.
