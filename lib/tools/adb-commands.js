 ...
 *
 * @param {Promise<boolean>} enabled - Whether to enable (true) or disable (false) the GPS provider.
 */
 ...
 *
 * @param {Promise<boolean>} on - True to enable the Airplane mode in Settings and false to disable it.
 */
 ...
 *
 * @param {Promise<string>} path - The path to be removed recursively.
 */
