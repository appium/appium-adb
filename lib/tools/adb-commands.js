 ...
 * @return {string} The output of the corresponding adb command. A string contains multiple forwarding lines with line break.
 */
methods.getForwardList = async function () {
  log.debug(`List forwarding ports`);
  return await this.adbExec(['forward', '--list']);
};
