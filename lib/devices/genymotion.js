...
Genymotion.prototype.launchAVD = function (avdName, avdArgs, language, locale, avdLaunchTimeout,
                                           avdReadyTimeout, cb, retry) {
  logger.info("Launching Genymotion:" + avdName + ", launchTimeout " +
  ...
  if (gmPlayer) {
    ...
    logger.debug("GM Player:" + gmPlayer);
