...
/* dumpsys iphonesubinfo would return Phone Subscriber Info
 *  eg:
 *  Phone Type = GSM
 *  Device ID = 000000000000000
 * IMEI id for emulator is 000000000000000
 */
ADB.prototype.isEmulator = function (cb) {
  var cmd = 'dumpsys iphonesubinfo';
  this.shell(cmd, function (err, stdout) {
    if (err) return cb(err);
    cb(null, stdout.indexOf('000000000000000') !== -1);
  });
};
